...
<template>
  <div class="space-y-0 relative">
    <section class="py-24 sm:py-32 relative overflow-hidden flex flex-col justify-center min-h-[85vh]">
      <div
        class="absolute -right-[15%] top-[-10%] w-[80vw] h-[80vw] max-w-200 max-h-200 bg-primary/10 rounded-full blur-[120px] pointer-events-none animate-pulse"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-end">
          <div class="lg:col-span-8">
            <h1
              ...
              Mindful<br>
              <span class="italic text-primary/90 block ml-[5vw] lg:ml-[10vw]">living.</span>
            </h1>
          </div>

          <div class="lg:col-span-4 pb-4 lg:pb-8">
            <div class="border-l border-primary/30 pl-8 space-y-8">
              ...
              <NuxtLink to="/blog" class="inline-flex items-center gap-6 group">
                <span
                  class="text-xs font-sans font-medium tracking-[0.3em] uppercase text-foreground group-hover:text-primary transition-colors">Begin
                  exploring</span>
                <span
    ...
    <section class="py-32 container mx-auto px-4 lg:px-16 relative z-10">
      <div class="flex flex-col md:flex-row justify-between items-end mb-24 border-b border-border/40 pb-8">
        ...
        <NuxtLink 
          ...
          Full Collection
          <span
            class="w-8 h-px bg-foreground/30 group-hover:w-12 group-hover:bg-primary transition-all duration-300"></span>
        </NuxtLink>
      </div>
        ...
        <NuxtLink 
          ...
          <Card class="border-0 rounded-none shadow-none bg-transparent h-full flex flex-col relative overflow-visible">
            ...
            <CardHeader
              ...
              <span class="text-foreground/40 font-sans tracking-[0.2em] text-[10px] mb-4 block uppercase">{{
                article.date }}</span>
              <CardTitle
